...
import static com.ssaa.camel.model.Activity.activity;
import static com.ssaa.camel.model.Condition.Builder.condition;
import static com.ssaa.camel.model.Link.Builder.link;
    ...
    private Set<Link> processOutputs(Activity lastSource, List<ProcessorDefinition<?>> outputs) {
        ...
        for (ProcessorDefinition<?> output : outputs) {
            if (output instanceof ToDefinition) {
                ...
                Activity target = activity(output.toString());
                links.add(
                        link()
                                .withSource(lastSource)
                                .withTarget(target)
